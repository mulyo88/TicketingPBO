...
class Common_Code extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('Tenancy/Inventory/MasterData/Common_Code/index', $data);
    ...
    public function create($code)
	{
		...
		$this->load->view('templates/header', $data);
		$this->load->view('templates/sidebar');
		$this->load->view('Tenancy/Inventory/MasterData/Common_Code/create', $data);
		$this->load->view('templates/footer');
	}
    ...
    public function store()
	{
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			redirect('Tenancy/Inventory/MasterData/Common_Code/create');
        }
        ...
        try {
            ...
            if ($exists > 0 ) {
                ...
                redirect('Tenancy/Inventory/MasterData/Common_Code/create/'.$this->input->post('code'));
            }
            ...
            if ($this->db->trans_status() === FALSE) {
                ...
                redirect('Tenancy/Inventory/MasterData/Common_Code/show/'.$this->input->post('code'));
            }
        } catch (Exception $e) {
            $this->db->trans_rollback();
    ...
    public function show($code)
    {
		...
		$this->load->view('templates/header', $data);
		$this->load->view('templates/sidebar');
		$this->load->view('Tenancy/Inventory/MasterData/Common_Code/show', $data);
		$this->load->view('templates/footer');
    }
    ...
    public function edit($id, $code)
	{
		...
		$this->load->view('templates/header', $data);
		$this->load->view('templates/sidebar');
		$this->load->view('Tenancy/Inventory/MasterData/Common_Code/edit', $data);
		$this->load->view('templates/footer');
	}
    ...
    public function update($id, $code)
	{
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            is_pesan('error','Unfornuately, something went wrong.');
            redirect('Tenancy/Inventory/MasterData/Common_Code/edit/'.$id.'/'.$code);
        }
        ...
        try {
            ...
            if ($this->db->trans_status() === FALSE) {
                ...
                redirect('Tenancy/Inventory/MasterData/Common_Code/show/'.$code);
            }
        } catch (Exception $e) {
            $this->db->trans_rollback();
