...
class Outgoing extends CI_Controller {
	...
	private function inquery_datalist_detail($date_from, $date_to, $area, $item_code, $item_name, $userlogin) {
		...
		$query = $this->db->query("EXEC dbo.sp_tnc_inven_r_outgoing_datalist '$date_from', '$date_to', '$area', '$item_code', '$item_name', '$userlogin'");
		return $query->result();
	}
    ...
    private function inquery_datalist_daily($date_from, $date_to, $area, $item_code, $item_name, $userlogin) {
		...
		$query = $this->db->query("EXEC dbo.sp_tnc_inven_r_outgoing_daily '$date_from', '$date_to', '$area', '$item_code', '$item_name', '$userlogin'");
		return $query->result();
	}
	...
	private function inquery_datalist_monthly($date_from, $date_to, $area, $item_code, $item_name, $userlogin) {
		...
		$query = $this->db->query("EXEC dbo.sp_tnc_inven_r_outgoing_monthly '$date_from', '$date_to', '$area', '$item_code', '$item_name', '$userlogin'");
		return $query->result();
	}
	...
	private function inquery_datalist_yearly($date_from, $date_to, $area, $item_code, $item_name, $userlogin) {
		...
		$query = $this->db->query("EXEC dbo.sp_tnc_inven_r_outgoing_yearly '$date_from', '$date_to', '$area', '$item_code', '$item_name', '$userlogin'");
		return $query->result();
	}
