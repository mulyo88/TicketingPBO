            ...
            <div class="panel-body">
                <div>
                    <button type="button" class="btn btn-primary" style="margin-bottom: 10px; margin-right: 5px;"
                        onclick="location.href='<?=site_url('Tenancy/MasterData/Property/Common_Code/create/'.$code)?>'">
                    ...
                    <button type="button" class="btn" style="background-color:black; color:white; margin-bottom: 10px;"
                        onclick="location.href='<?=site_url('Tenancy/MasterData/Property/Common_Code/index')?>'"
                    >
                        ...
                        <tbody>
                            <?php foreach ($results as $row): ?>
                                <tr>
                                    ...
                                    <td class="text-capitalize"><?= $row->updated_at ?></td>

                                    <td class="text-center">
                                        <a href="<?= site_url('Tenancy/MasterData/Property/Common_Code/edit/'.$row->id.'/'.$row->code); ?>" class="label label-warning">
                                            <i class="fa fa-edit"></i><span style="margin-left: 5px;">Edit</span>
                                        </a>

                                        <a onclick="return confirm('Are you sure?')" href="<?= site_url('Tenancy/MasterData/Property/Common_Code/destroy/'.$row->id.'/'.$row->code); ?>" class="label label-danger" style="margin-left: 5px;">
