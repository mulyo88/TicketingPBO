    ...
    <section class="content">
        ...
        <div class="panel">
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-6">
                        <form method="post" action="<?= site_url('Tenancy/MasterData/Property/Common_Code/store') ?>">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col">
                            ...
                            <div class="box-footer">
                                ...
                                <?php else : ?>
                                    <button type="button" class="btn pull-right" style="background-color:black; color:white; margin-right: 15px;"
                                        onclick="location.href='<?=site_url('Tenancy/MasterData/Property/Common_Code/show/'.$code)?>'"
                                    >
                                        <i class="fa fa-undo"></i><span style="margin-left: 5px;">Back to List</span>
                                    </button>
                                <?php endif; ?>
