    ...
    <section class="content">
        ...
        <div class="panel">
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-6">
                        <form method="post" action="<?= site_url('Tenancy/MasterData/Property/Building/store') ?>">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" id="operation_time" name="operation_time" placeholder="Operation Time (Hour)" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
