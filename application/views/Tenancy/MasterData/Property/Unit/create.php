...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <form method="post" action="<?= site_url('Tenancy/MasterData/Property/Unit/store') ?>">
            <div class="panel">
                            ...
                            <div class="col-md-6">
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="unit_size" class="col-sm-2 control-label text-capitalize">size m<sup>2</sup></label>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="basic_price" class="col-sm-2 control-label text-capitalize">price</label>

                                                <div class="col-sm-10">
                                                    <input type="number" step="any" class="form-control" id="basic_price" name="basic_price" placeholder="Basic Price" required >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
