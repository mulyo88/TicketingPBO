    ...
    <section class="content">
        ...
        <div class="panel">
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-6">
                        <form method="post" action="<?= site_url('Tenancy/MasterData/Tax/update/'.$result->id) ?>">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                value="<?php echo number_format((float)$result->tax, 2, '.', ''); ?>"
                                            >
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        document.getElementById("date_register").value = moment(new Date(<?php echo json_encode($result->date_register); ?>)).format('DD-MMM-YYYY');
