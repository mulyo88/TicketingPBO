        ...
        <div class="panel">
            <div class="panel-body">
                <button type="button" class="btn" style="background-color:black; color:white; margin-bottom: 10px;"
                    onclick="location.href='<?=site_url('Tenancy/MasterData/Letter_Line/create')?>'">
                    ...
                    <table id="tbl" class="table table-sm table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center text-capitalize">company</th>
                                <th class="text-center text-capitalize">name</th>
                                <th class="text-center text-capitalize">position</th>
                        ...
                        <tbody>
                            <?php foreach ($results as $row): ?>
                                <tr>
                                    <td class="text-capitalize"><?= $row->party_type ?></td>
                                    <td class="text-capitalize"><?= $row->party_name ?></td>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= site_url('Tenancy/MasterData/Letter_Line/edit/'.$row->id); ?>" class="label label-warning">
                                            <i class="fa fa-edit"></i><span style="margin-left: 5px;">Edit</span>
                                        </a>

                                        <a onclick="return confirm('Are you sure?')" href="<?= site_url('Tenancy/MasterData/Letter_Line/destroy/'.$row->id); ?>" class="label label-danger" style="margin-left: 5px;">
