...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <form method="post" action="<?= site_url('Tenancy/Tenant/Tenant/update/'.$result->id) ?>">
            <div class="panel">
                <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="owner" class="col-sm-3 control-label text-capitalize">owner name</label>

                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="owner" name="owner" placeholder="Owner Name"
                                                    value="<?php echo $result->owner; ?>" required
                                                >
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="brand" class="col-sm-3 control-label text-capitalize">brand name</label>

                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="brand" name="brand" placeholder="Brand Name"
                                                    value="<?php echo $result->brand; ?>" required
                                                >
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="product" class="col-sm-3 control-label text-capitalize">product name</label>

                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="product" name="product" placeholder="Product Name"  
                                                    value="<?php echo $result->product; ?>" required
                                                >
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="telp" name="telp" placeholder="Phone Number"
                                                    value="<?php echo $result->telp; ?>" required
                                                >
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="box-footer">
                        <button type="button" class="btn pull-right" style="background-color:black; color:white; margin-right: 15px;"
                            onclick="location.href='<?=site_url('Tenancy/Tenant/Tenant/index')?>'"
                        >
