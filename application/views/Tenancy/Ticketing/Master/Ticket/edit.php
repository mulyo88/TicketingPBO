...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="text-capitalize active"><a href="<?= site_url('Tenancy/Ticketing/Master/Ticket/edit/'.$result->id) ?>"><?php echo $judul ?></a></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <form method="post" action="<?= site_url('Tenancy/Ticketing/Master/Ticket/update/'.$result->id) ?>">
            <div class="panel">
                        ...
                        <div class="col-md-6">
                            <div class="box-body">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                >
                                                    <?php foreach ($building as $row): ?>
                                                        <option value="<?= $row->code ?>"<?= old('area') ? (old('area') == $row->code ? 'selected' : '') : ($result->venue ? ($result->venue->area == $row->code ? 'selected' : '') : '') ?>><?= $row->code . ' - ' . $row->name ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                                <?= error('area') ?>
                                            </div>
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                >
                                                    <?php foreach ($category as $row): ?>
                                                        <option value="<?= $row->name ?>"<?= old('category') ? (old('category') == $row->name ? 'selected' : '') : ($result->category ? ($result->category == $row->name ? 'selected' : '') : '') ?>><?= $row->name ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                >
                                                    ...
                                                    <?php foreach ($type as $row): ?>
                                                        <option value="<?= $row->name ?>"<?= old('type') ? (old('type') == $row->name ? 'selected' : '') : ($result->type ? ($result->type == $row->name ? 'selected' : '') : '') ?>><?= $row->name ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="party" id="party" class="form-control"
                                                    <?= invalid('party') ?>
                                                >
                                                    <option value=""<?= old('party') == '' ? 'selected' : '' ?>>None</option>

                                                    <?php foreach ($party as $row): ?>
                                                        <option value="<?= $row->name ?>"<?= old('party') ? (old('party') == $row->name ? 'selected' : '') : ($result->party ? ($result->party == $row->name ? 'selected' : '') : '') ?>><?= $row->name ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                ...
                                <!-- <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="price" class="col-sm-2 control-label text-capitalize">price</label>

                                            <div class="col-sm-10">
                                                <input type="number" any="step" class="form-control" id="price" name="price" placeholder="Price"
                                                    value="<?php echo old('price') ? old('price') : $result->price; ?>" style="text-align: right;" required
                                                    <?= invalid('price') ?>
                                                >
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="nav-tabs-custom">
                                ...
                                <div class="tab-content no-padding">
                                    <?php
                                        $xprice = json_encode($result->xprice);
                                        $xprice_arr  = json_decode($xprice, true);
                                        $count = count($xprice_arr);

                                        $monday_amount = '0';
                                        $monday_discount = '0';
                                        $monday_buy_ticket = '0';
                                        $monday_free_ticket = '0';
                                        $monday_is_active = '1';

                                        $tuesday_amount = '0';
                                        $tuesday_discount = '0';
                                        $tuesday_buy_ticket = '0';
                                        $tuesday_free_ticket = '0';
                                        $tuesday_is_active = '1';

                                        $wednesday_amount = '0';
                                        $wednesday_discount = '0';
                                        $wednesday_buy_ticket = '0';
                                        $wednesday_free_ticket = '0';
                                        $wednesday_is_active = '1';

                                        $thursday_amount = '0';
                                        $thursday_discount = '0';
                                        $thursday_buy_ticket = '0';
                                        $thursday_free_ticket = '0';
                                        $thursday_is_active = '1';

                                        $friday_amount = '0';
                                        $friday_discount = '0';
                                        $friday_buy_ticket = '0';
                                        $friday_free_ticket = '0';
                                        $friday_is_active = '1';

                                        $saturday_amount = '0';
                                        $saturday_discount = '0';
                                        $saturday_buy_ticket = '0';
                                        $saturday_free_ticket = '0';
                                        $saturday_is_active = '1';

                                        $sunday_amount = '0';
                                        $sunday_discount = '0';
                                        $sunday_buy_ticket = '0';
                                        $sunday_free_ticket = '0';
                                        $sunday_is_active = '1';

                                        for ($i=0; $i < $count; $i++) {
                                            if ($xprice_arr[$i]['day_name'] == 'Monday') {
                                                $monday_amount = $xprice_arr[$i]['amount'];
                                                $monday_discount = $xprice_arr[$i]['discount'];
                                                $monday_buy_ticket = $xprice_arr[$i]['buy_ticket'];
                                                $monday_free_ticket = $xprice_arr[$i]['free_ticket'];
                                                $monday_is_active = $xprice_arr[$i]['is_active'];
                                            }

                                            if ($xprice_arr[$i]['day_name'] == 'Tuesday') {
                                                $tuesday_amount = $xprice_arr[$i]['amount'];
                                                $tuesday_discount = $xprice_arr[$i]['discount'];
                                                $tuesday_buy_ticket = $xprice_arr[$i]['buy_ticket'];
                                                $tuesday_free_ticket = $xprice_arr[$i]['free_ticket'];
                                                $tuesday_is_active = $xprice_arr[$i]['is_active'];
                                            }

                                            if ($xprice_arr[$i]['day_name'] == 'Wednesday') {
                                                $wednesday_amount = $xprice_arr[$i]['amount'];
                                                $wednesday_discount = $xprice_arr[$i]['discount'];
                                                $wednesday_buy_ticket = $xprice_arr[$i]['buy_ticket'];
                                                $wednesday_free_ticket = $xprice_arr[$i]['free_ticket'];
                                                $wednesday_is_active = $xprice_arr[$i]['is_active'];
                                            }

                                            if ($xprice_arr[$i]['day_name'] == 'Thursday') {
                                                $thursday_amount = $xprice_arr[$i]['amount'];
                                                $thursday_discount = $xprice_arr[$i]['discount'];
                                                $thursday_buy_ticket = $xprice_arr[$i]['buy_ticket'];
                                                $thursday_free_ticket = $xprice_arr[$i]['free_ticket'];
                                                $thursday_is_active = $xprice_arr[$i]['is_active'];
                                            }

                                            if ($xprice_arr[$i]['day_name'] == 'Friday') {
                                                $friday_amount = $xprice_arr[$i]['amount'];
                                                $friday_discount = $xprice_arr[$i]['discount'];
                                                $friday_buy_ticket = $xprice_arr[$i]['buy_ticket'];
                                                $friday_free_ticket = $xprice_arr[$i]['free_ticket'];
                                                $friday_is_active = $xprice_arr[$i]['is_active'];
                                            }

                                            if ($xprice_arr[$i]['day_name'] == 'Saturday') {
                                                $saturday_amount = $xprice_arr[$i]['amount'];
                                                $saturday_discount = $xprice_arr[$i]['discount'];
                                                $saturday_buy_ticket = $xprice_arr[$i]['buy_ticket'];
                                                $saturday_free_ticket = $xprice_arr[$i]['free_ticket'];
                                                $saturday_is_active = $xprice_arr[$i]['is_active'];
                                            }

                                            if ($xprice_arr[$i]['day_name'] == 'Sunday') {
                                                $sunday_amount = $xprice_arr[$i]['amount'];
                                                $sunday_discount = $xprice_arr[$i]['discount'];
                                                $sunday_buy_ticket = $xprice_arr[$i]['buy_ticket'];
                                                $sunday_free_ticket = $xprice_arr[$i]['free_ticket'];
                                                $sunday_is_active = $xprice_arr[$i]['is_active'];
                                            }
                                        }
                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[monday][amount]" name="xprice[monday][amount]" placeholder="price (Cost of Goods Sold/HPP)"
                                                            value="<?php echo old('xprice[monday][amount]') ? old('xprice[monday][amount]') : $monday_amount; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[monday][discount]" name="xprice[monday][discount]" placeholder="Discount %"
                                                            value="<?php echo old('xprice[monday][discount]') ? old('xprice[monday][discount]') : $monday_discount; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="buy_monday" name="xprice[monday][buy]" placeholder="Buy Ticket (Promotion)"
                                                            value="<?php echo old('xprice[monday][buy]') ? old('xprice[monday][buy]') : $monday_buy_ticket; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[monday][free]" name="xprice[monday][free]" placeholder="Free Ticket (Promotion)"
                                                            value="<?php echo old('xprice[monday][free]') ? old('xprice[monday][free]') : $monday_free_ticket; ?>" style="text-align: right;"
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" id="xprice[monday][is_active]" name="xprice[monday][is_active]"
                                                                    <?php echo $monday_is_active == 1 ? 'checked' : ''; ?>
                                                                > Is Active
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[tuesday][amount]" name="xprice[tuesday][amount]" placeholder="price (Cost of Goods Sold/HPP)"
                                                            value="<?php echo old('xprice[tuesday][amount]') ? old('xprice[tuesday][amount]') : $tuesday_amount; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[tuesday][discount]" name="xprice[tuesday][discount]" placeholder="Discount %"
                                                            value="<?php echo old('xprice[tuesday][discount]') ? old('xprice[tuesday][discount]') : $tuesday_discount; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="buy_tuesday" name="xprice[tuesday][buy]" placeholder="Buy Ticket (Promotion)"
                                                            value="<?php echo old('xprice[tuesday][buy]') ? old('xprice[tuesday][buy]') : $tuesday_buy_ticket; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[tuesday][free]" name="xprice[tuesday][free]" placeholder="Free Ticket (Promotion)"
                                                            value="<?php echo old('xprice[tuesday][free]') ? old('xprice[tuesday][free]') : $tuesday_free_ticket; ?>" style="text-align: right;"
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" id="xprice[tuesday][is_active]" name="xprice[tuesday][is_active]"
                                                                    <?php echo $tuesday_is_active == 1 ? 'checked' : ''; ?>
                                                                > Is Active
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[wednesday][amount]" name="xprice[wednesday][amount]" placeholder="price (Cost of Goods Sold/HPP)"
                                                            value="<?php echo old('xprice[wednesday][amount]') ? old('xprice[wednesday][amount]') : $wednesday_amount; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[wednesday][discount]" name="xprice[wednesday][discount]" placeholder="Discount %"
                                                            value="<?php echo old('xprice[wednesday][discount]') ? old('xprice[wednesday][discount]') : $wednesday_discount; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="buy_wednesday" name="xprice[wednesday][buy]" placeholder="Buy Ticket (Promotion)"
                                                            value="<?php echo old('xprice[wednesday][buy]') ? old('xprice[wednesday][buy]') : $wednesday_buy_ticket; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[wednesday][free]" name="xprice[wednesday][free]" placeholder="Free Ticket (Promotion)"
                                                            value="<?php echo old('xprice[wednesday][free]') ? old('xprice[wednesday][free]') : $wednesday_free_ticket; ?>" style="text-align: right;"
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" id="xprice[wednesday][is_active]" name="xprice[wednesday][is_active]"
                                                                    <?php echo $wednesday_is_active == 1 ? 'checked' : ''; ?>
                                                                > Is Active
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[thursday][amount]" name="xprice[thursday][amount]" placeholder="price (Cost of Goods Sold/HPP)"
                                                            value="<?php echo old('xprice[thursday][amount]') ? old('xprice[thursday][amount]') : $thursday_amount; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[thursday][discount]" name="xprice[thursday][discount]" placeholder="Discount %"
                                                            value="<?php echo old('xprice[thursday][discount]') ? old('xprice[thursday][discount]') : $thursday_discount; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="buy_thursday" name="xprice[thursday][buy]" placeholder="Buy Ticket (Promotion)"
                                                            value="<?php echo old('xprice[thursday][buy]') ? old('xprice[thursday][buy]') : $thursday_buy_ticket; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[thursday][free]" name="xprice[thursday][free]" placeholder="Free Ticket (Promotion)"
                                                            value="<?php echo old('xprice[thursday][free]') ? old('xprice[thursday][free]') : $thursday_free_ticket; ?>" style="text-align: right;"
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" id="xprice[thursday][is_active]" name="xprice[thursday][is_active]"
                                                                    <?php echo $thursday_is_active == 1 ? 'checked' : ''; ?>
                                                                > Is Active
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[friday][amount]" name="xprice[friday][amount]" placeholder="price (Cost of Goods Sold/HPP)"
                                                            value="<?php echo old('xprice[friday][amount]') ? old('xprice[friday][amount]') : $friday_amount; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[friday][discount]" name="xprice[friday][discount]" placeholder="Discount %"
                                                            value="<?php echo old('xprice[friday][discount]') ? old('xprice[friday][discount]') : $friday_discount; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="buy_friday" name="xprice[friday][buy]" placeholder="Buy Ticket (Promotion)"
                                                            value="<?php echo old('xprice[friday][buy]') ? old('xprice[friday][buy]') : $friday_buy_ticket; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[friday][free]" name="xprice[friday][free]" placeholder="Free Ticket (Promotion)"
                                                            value="<?php echo old('xprice[friday][free]') ? old('xprice[friday][free]') : $friday_free_ticket; ?>" style="text-align: right;"
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" id="xprice[friday][is_active]" name="xprice[friday][is_active]"
                                                                    <?php echo $friday_is_active == 1 ? 'checked' : ''; ?>
                                                                > Is Active
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[saturday][amount]" name="xprice[saturday][amount]" placeholder="price (Cost of Goods Sold/HPP)"
                                                            value="<?php echo old('xprice[saturday][amount]') ? old('xprice[saturday][amount]') : $saturday_amount; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[saturday][discount]" name="xprice[saturday][discount]" placeholder="Discount %"
                                                            value="<?php echo old('xprice[saturday][discount]') ? old('xprice[saturday][discount]') : $saturday_discount; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="buy_saturday" name="xprice[saturday][buy]" placeholder="Buy Ticket (Promotion)"
                                                            value="<?php echo old('xprice[saturday][buy]') ? old('xprice[saturday][buy]') : $saturday_buy_ticket; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[saturday][free]" name="xprice[saturday][free]" placeholder="Free Ticket (Promotion)"
                                                            value="<?php echo old('xprice[saturday][free]') ? old('xprice[saturday][free]') : $saturday_free_ticket; ?>" style="text-align: right;"
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" id="xprice[saturday][is_active]" name="xprice[saturday][is_active]"
                                                                    <?php echo $saturday_is_active == 1 ? 'checked' : ''; ?>
                                                                > Is Active
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[sunday][amount]" name="xprice[sunday][amount]" placeholder="price (Cost of Goods Sold/HPP)"
                                                            value="<?php echo old('xprice[sunday][amount]') ? old('xprice[sunday][amount]') : $sunday_amount; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[sunday][discount]" name="xprice[sunday][discount]" placeholder="Discount %"
                                                            value="<?php echo old('xprice[sunday][discount]') ? old('xprice[sunday][discount]') : $sunday_discount; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="buy_sunday" name="xprice[sunday][buy]" placeholder="Buy Ticket (Promotion)"
                                                            value="<?php echo old('xprice[sunday][buy]') ? old('xprice[sunday][buy]') : $sunday_buy_ticket; ?>" style="text-align: right;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" any="step" class="form-control" id="xprice[sunday][free]" name="xprice[sunday][free]" placeholder="Free Ticket (Promotion)"
                                                            value="<?php echo old('xprice[sunday][free]') ? old('xprice[sunday][free]') : $sunday_free_ticket; ?>" style="text-align: right;"
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" id="xprice[sunday][is_active]" name="xprice[sunday][is_active]"
                                                                    <?php echo $sunday_is_active == 1 ? 'checked' : ''; ?>
                                                                > Is Active
                                                            </label>
                                                        </div>
                                                    </div>
...
<script>
    ...
    function load_vanue(value, id = <?php echo json_encode(old('vanue_id')); ?>) {
        ...
        if (id == '') {
            id = <?php echo json_encode($result); ?>;
            id = id.vanue_id;
        }
