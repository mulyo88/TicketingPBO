...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="text-capitalize active"><a href="<?= site_url('Tenancy/Ticketing/Master/Common_Code/edit/'.$result->id.'/'.$code) ?>"><?php echo $judul ?></a></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="panel">
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-6">
                        <form method="post" action="<?= site_url('Tenancy/Ticketing/Master/Common_Code/update/'.$result->id.'/'.$code) ?>">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="note" name="note" placeholder="Note"
                                                    value="<?php echo old('note') ? old('note') : $result->note; ?>"
                                                    <?= invalid('note') ?>
                                                >
                                                <?= error('note') ?>
