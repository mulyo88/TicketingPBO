...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="text-capitalize active"><a href="<?= site_url('Tenancy/Ticketing/Master/Gate/create') ?>"><?php echo $judul ?></a></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="panel">
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-6">
                        <form method="post" action="<?= site_url('Tenancy/Ticketing/Master/Gate/store') ?>">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col">
