...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="text-capitalize active"><a href="<?= site_url('Tenancy/Ticketing/Master/Venue/index') ?>"><?php echo $judul ?></a></li>
        </ol>
    </section>
        ...
        <div class="panel">
            <div class="panel-body">
                <button type="button" class="btn" style="background-color:black; color:white; margin-bottom: 10px;"
                    onclick="location.href='<?=site_url('Tenancy/Ticketing/Master/Venue/create')?>'">
                    ...
                    <table id="tbl" class="table table-sm table-bordered">
                        ...
                        <tbody>
                            <?php foreach ($results as $row): ?>
                                <tr>
                                    <td class="text-capitalize"><?= ($row->building ? $row->building->code : '') . ' - ' . ($row->building ? $row->building->name : '') ?></td>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= site_url('Tenancy/Ticketing/Master/Venue/edit/'.$row->id); ?>" class="label label-warning">
                                            <i class="fa fa-edit"></i><span style="margin-left: 5px;">Edit</span>
                                        </a>

                                        <a onclick="return confirm('Are you sure?')" href="<?= site_url('Tenancy/Ticketing/Master/Venue/destroy/'.$row->id); ?>" class="label label-danger" style="margin-left: 5px;">
