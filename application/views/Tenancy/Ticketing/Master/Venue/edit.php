...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="text-capitalize active"><a href="<?= site_url('Tenancy/Ticketing/Master/Venue/edit/'.$result->id) ?>"><?php echo $judul ?></a></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="panel">
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-6">
                        <form method="post" action="<?= site_url('Tenancy/Ticketing/Master/Venue/update/'.$result->id) ?>">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                >
                                                    <?php foreach ($building as $row): ?>
                                                        <option value="<?= $row->code ?>"<?= old('area') ? (old('area') == $row->code ? 'selected' : '') : ($result->area == $row->code ? 'selected' : '') ?>><?= $row->code . ' - ' . $row->name ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                                <?= error('area') ?>
                                            </div>
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn pull-right" style="background-color:black; color:white; margin-right: 15px;"
                                    onclick="location.href='<?=site_url('Tenancy/Ticketing/Master/Venue/index')?>'"
                                >
