...
<div class="google-search">
    <div class="input-group position-relative">
        ...
        <button class="btn google-btn" type="button" onclick="checkin_scan()">
    ...
    <script>
        ...
        async function checkin_scan() {
            ...
            try {
                ...
                $.ajax({
                    url: "<?= site_url('Tenancy/API/GlobalAPI_Trans/ticketing_checkin_scan_search_barcode') ?>",
                    type: "POST",
                    dataType: "json",
                    data: {
                        barcode: keyword,
                    ...
                    success: function(data) {
                        ...
                        } else if (data.msg == 'already checkin') {
                            add_information(keyword.trim() + ' ' + data.msg, 'bg-warning');
