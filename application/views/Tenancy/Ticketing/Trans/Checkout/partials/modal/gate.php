                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="#" class="label" style="background-color:black; color:white;"
                                                onclick="location.href='<?=site_url('Tenancy/Ticketing/Trans/Checkout/create/'.($row->venue ? ($row->venue->building ? $row->venue->building->code : 'none') : 'none').'/'.($row->venue ? $row->venue->code : 'none').'/'.$row->code)?>'"
                                                data-dismiss="modal"
                                            >
