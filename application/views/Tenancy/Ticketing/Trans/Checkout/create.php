...
<?php start_section('content'); ?>
    <?php include_view('Tenancy/Ticketing/Trans/Checkout/partials/fn_input'); ?>
    ...
    <form method="post" action="<?= site_url('Tenancy/Ticketing/Trans/Checkout/store/'.$building_code.'/'.$venue_code.'/'.$gate_code) ?>">
        ...
        <div class="p-2">
            <div class="row">
                <div class="col-md-8">
                    <div class="m-2 mb-2">
                        <?php include_view('Tenancy/Ticketing/Trans/Checkout/partials/search'); ?>
                    </div>

                    <div class="m-2 mb-2">
                        <?php include_view('Tenancy/Ticketing/Trans/Checkout/partials/information'); ?>
                ...
                <div class="col-md-4">
                    <?php include_view('Tenancy/Ticketing/Trans/Checkout/partials/card-statistic'); ?>
                </div>
            </div>
        ...
        function reload_data() {
            if (confirm("Are you sure?")) {
                if (fn_input_type == 'create') {
                    location.href = "<?= site_url('Tenancy/Ticketing/Trans/Checkout/create/') ?>" + fn_building.code + '/' + fn_venue.code + '/' + fn_gate.code;
                } else if (fn_input_type == 'edit') {
                    location.href = "<?= site_url('Tenancy/Ticketing/Trans/Checkout/edit/') ?>" + fn_result.id;
                }
            }
        }
    </script>
