...
<?php include_view('Tenancy/Inventory/Report/Incoming/partials/datalist_simple'); ?>
<?php include_view('Tenancy/Inventory/Report/Incoming/partials/datalist_detail'); ?>
<?php include_view('Tenancy/Inventory/Report/Incoming/partials/daily'); ?>
<?php include_view('Tenancy/Inventory/Report/Incoming/partials/monthly'); ?>
<?php include_view('Tenancy/Inventory/Report/Incoming/partials/yearly'); ?>
...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="text-capitalize active"><a href="<?= site_url('Tenancy/Inventory/Report/Incoming/index') ?>"><?php echo $judul ?></a></li>
        </ol>
    </section>

    <section class="content">
        <form method="GET" action="<?= site_url('Tenancy/Inventory/Report/Incoming/index') ?>">
            <div class="panel">
...
<script type="text/javascript">
    ...
    function export_mode() {
        ...
        if (document.getElementById("type").value == 'DataList') {
            if (document.getElementById("mode").value == 'Simple') {
                element = document.getElementById('tbl_incoming_datalist_simple');
                if (element) {
                    export_data('tbl_incoming_datalist_simple');
                } else {
                    alert('inquiry please!');
                }
            } else if (document.getElementById("mode").value == 'Detail') {
                element = document.getElementById('tbl_incoming_datalist_detail');
                if (element) {
                    export_data('tbl_incoming_datalist_detail');
                } else {
                    alert('inquiry please!');
                }
            } else {
            ...
            element = document.getElementById('tbl_incoming_daily');
            if (element) {
                export_data('tbl_incoming_daily');
            } else {
                alert('inquiry please!');
            }
        } else if (document.getElementById("type").value == 'Monthly') {
            element = document.getElementById('tbl_incoming_monthly');
            if (element) {
                export_data('tbl_incoming_monthly');
            } else {
                alert('inquiry please!');
            }
        } else if (document.getElementById("type").value == 'Yearly') {
            element = document.getElementById('tbl_incoming_yearly');
            if (element) {
                export_data('tbl_incoming_yearly');
            } else {
                alert('inquiry please!');
            }
        } else {
