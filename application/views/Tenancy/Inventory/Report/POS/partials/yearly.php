<?php start_section('page-script-yearly'); ?>
    <script>
        function load_yearly() {
            ...
            var html = '';
            html += '<table id="tbl_pos_yearly" class="table table-bordered table-striped" style="table-layout: fixed; width: 100%;">';
                html += '<colgroup>';
                    ...
                    html += '<tr style="position:sticky; top:0; z-index:41;">';
                        html += '<th rowspan="2" class="text-capitalize" style="text-align: center; vertical-align: middle; position:sticky; left:0; top:0; z-index:60; background:#B3B3B3;">area</th>';
                            ...
                            for (let day = 1; day <= 12; day++) {
                                ...
                                html += '<th colspan="2" style="text-align: center; vertical-align: middle;">' + moment(dt).format('YYYY') + '</th>';
                            }
                    html += '</tr>';
