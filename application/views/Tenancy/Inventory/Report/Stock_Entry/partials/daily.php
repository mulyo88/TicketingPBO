<?php start_section('page-script-daily'); ?>
    <script>
        function load_daily() {
            ...
            var html = '';
            html += '<table id="tbl_stock_entry_daily" class="table table-bordered table-striped" style="table-layout: fixed; width: 100%;">';
                html += '<colgroup>';
                    html += '<col style="width:300px;">';   // Area
                    html += '<col style="width:150px;">';   // status
                ...
                html += '<thead style="background-color: #B3B3B3; color: black; position:sticky; top:0; z-index:40;">';
                    html += '<tr style="position:sticky; top:0; z-index:41;">';
                        ...
                        html += '<th class="text-capitalize" style="text-align: center; vertical-align: middle; position:sticky; left:300px; top:0; z-index:59; background:#B3B3B3;">status</th>';
                            ...
                            for (let day = 1; day <= 31; day++) {
                                ...
                                html += '<th style="text-align: center; vertical-align: middle; ' + color + '">' + moment(dt).format('DD-MMM') + '</th>';
                            }
                    html += '</tr>';
                html += '</thead>';
                html += '<tbody>';
                    for (let index = 0; index < results.length; index++) {
                        html += '<tr>';
                            ...
                            html += '<td class="text-capitalize" style="position:sticky; left:300px; top:auto; background:#F2F2F2; z-index:29;">' + results[index].status + '</td>';
