<?php start_section('page-script-yearly'); ?>
    <script>
        function load_yearly() {
            ...
            var html = '';
            html += '<table id="tbl_stock_entry_yearly" class="table table-bordered table-striped" style="table-layout: fixed; width: 100%;">';
                html += '<colgroup>';
                    ...
                    html += '<tr style="position:sticky; top:0; z-index:41;">';
                        ...
                        html += '<th class="text-capitalize" style="text-align: center; vertical-align: middle; position:sticky; left:300px; top:0; z-index:59; background:#B3B3B3;">status</th>';
                            ...
                            for (let day = 1; day <= 12; day++) {
                                ...
                                html += '<th style="text-align: center; vertical-align: middle;">' + moment(dt).format('YYYY') + '</th>';
                            }
                    html += '</tr>';
                html += '</thead>';
                html += '<tbody>';
