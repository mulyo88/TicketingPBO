...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <form method="post" action="<?= site_url('Tenancy/Inventory/Selling/Customer/store') ?>">
            <div class="panel">
                <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="name" class="col-sm-3 control-label text-capitalize">name</label>
                    ...
                    <div class="box-footer">
                        <button type="button" class="btn pull-right" style="background-color:black; color:white; margin-right: 15px;"
                            onclick="location.href='<?=site_url('Tenancy/Inventory/Selling/Customer/index')?>'"
                        >
