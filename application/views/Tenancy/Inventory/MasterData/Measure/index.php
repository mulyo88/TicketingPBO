        ...
        <div class="panel">
            <div class="panel-body">
                <button type="button" class="btn" style="background-color:black; color:white; margin-bottom: 10px;"
                    onclick="location.href='<?=site_url('Tenancy/Inventory/MasterData/Measure/create')?>'">
                            ...
                            <?php foreach ($results as $row): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= site_url('Tenancy/Inventory/MasterData/Measure/edit/'.$row->id); ?>" class="label label-warning">
                                            <i class="fa fa-edit"></i><span style="margin-left: 5px;">Edit</span>
                                        </a>

                                        <a onclick="return confirm('Are you sure?')" href="<?= site_url('Tenancy/Inventory/MasterData/Measure/destroy/'.$row->id); ?>" class="label label-danger" style="margin-left: 5px;">
