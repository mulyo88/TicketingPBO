    ...
    <section class="content">
        ...
        <div class="panel">
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-6">
                        <form method="post" action="<?= site_url('Tenancy/Inventory/MasterData/Payload_Acquirer/update/'.$result->payment_gate_id) ?>">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                >
                                                    <?php foreach ($payload_type as $row): ?>
                                                        <option value="<?=$row->id?>" <?= old('payload_id') ? (old('payload_id') == $row->id ? 'selected' : '') : ($result->payload_id == $row->id ? 'selected' : '') ?>><?=$row->name?></option>
                                                    <?php endforeach ?>
                                                </select>
