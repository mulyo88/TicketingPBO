        ...
        <div class="panel">
            <div class="panel-body">
                <button type="button" class="btn" style="background-color:black; color:white; margin-bottom: 10px;"
                    onclick="location.href='<?=site_url('Tenancy/Inventory/MasterData/Payment_Method/create')?>'">
                ...
                <div class="table-responsive">
                    <table id="tbl" class="table table-sm table-bordered">
                        <thead>
                            <tr>
                                <th class="text-center text-capitalize">payment method</th>
                        ...
                        <tbody>
                            <?php foreach ($results as $row): ?>
                                <tr>
                                    ...
                                    <td class="text-capitalize"><?= $row->payment_gate_type->name ?></td>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= site_url('Tenancy/Inventory/MasterData/Payment_Method/edit/'.$row->method_id.'/'.$row->payment_gate_id); ?>" class="label label-warning">
                                            <i class="fa fa-edit"></i><span style="margin-left: 5px;">Edit</span>
                                        </a>

                                        <a onclick="return confirm('Are you sure?')" href="<?= site_url('Tenancy/Inventory/MasterData/Payment_Method/destroy/'.$row->method_id.'/'.$row->payment_gate_id); ?>" class="label label-danger" style="margin-left: 5px;">
