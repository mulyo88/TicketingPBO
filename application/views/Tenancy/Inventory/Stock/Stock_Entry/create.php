<?php include_view('Tenancy/Inventory/Stock/Stock_Entry/partials/fn_input'); ?>
<?php include_view('Tenancy/Inventory/Stock/Stock_Entry/partials/header'); ?>
<?php include_view('Tenancy/Inventory/Stock/Stock_Entry/partials/detail'); ?>
<?php include_view('Tenancy/Inventory/Stock/Stock_Entry/partials/modal/item'); ?>
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <form method="post" action="<?= site_url('Tenancy/Inventory/Stock/Stock_Entry/store') ?>">
