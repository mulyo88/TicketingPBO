<?php include_view('Tenancy/Inventory/Stock/Incoming/partials/fn_input'); ?>
<?php include_view('Tenancy/Inventory/Stock/Incoming/partials/header'); ?>
<?php include_view('Tenancy/Inventory/Stock/Incoming/partials/detail'); ?>
<?php include_view('Tenancy/Inventory/Stock/Incoming/partials/modal/item'); ?>
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <form method="post" action="<?= site_url('Tenancy/Inventory/Stock/Incoming/update/'.$result->id) ?>">
