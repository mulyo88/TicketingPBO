<?php start_section('page-script-fn-input'); ?>
    <script>
        ...
        var fn_from_type = <?php echo json_encode($from_type); ?>;
        var fn_from_type_common = <?php echo json_encode($from_type_common); ?>;
        var fn_building = <?php echo json_encode($building); ?>;

        var fn_i_date_trans = new Date();
        var fn_i_building_id = null;
        var fn_i_from_type = null;
        var fn_i_from_id = null;
        var fn_i_qty = 0;
        var fn_i_note = null;
        ...
        function init_input() {
            if (old) {
                ...
                fn_i_from_type = <?php echo json_encode(old('from_type')); ?>;
                fn_i_from_id = <?php echo json_encode(old('from_id')); ?>;
                ...
                fn_i_from_type = fn_from_type_common ? fn_from_type_common.id : null;
                fn_i_from_id = fn_result.from_id;
