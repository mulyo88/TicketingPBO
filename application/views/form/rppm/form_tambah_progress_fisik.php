<form id="MyForm" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <form class="form-horizontal">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="RencanaFisTB" id="RencanaFisTB" class="form-control" placeholder="0.00" onkeypress="return hanyaAngka(event)" autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-lg-4 col-form-label">Realisasi Fisik Tahun Berjalan (%)</label>
                <div class="col-sm-8">
                    <input type="text" name="RealisasiFisTB" id="RealisasiFisTB" class="form-control" placeholder="0.00" onkeypress="return hanyaAngka(event)" autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-lg-4 col-form-label">Realisasi Keuangan Tahun Berjalan (%)</label>
                <div class="col-sm-8">
                    <input type="text" name="RealisasiKeuTB" id="RealisasiKeuTB" class="form-control" placeholder="0.00" onkeypress="return hanyaAngka(event)" autocomplete="off">
                </div>
            </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" name="RencanaFiskom" id="RencanaFiskom" class="form-control" placeholder="0.00" onkeypress="return hanyaAngka(event)" value="<?= $RencanaK ?>" readonly>
        </div>
    </div>
    <div class="form-group row">
        <label class="col-lg-4 col-form-label">Realisasi Fisik Komulatif (%)</label>
        <div class="col-sm-8">
            <input type="text" name="RealisasiFiskom" id="RealisasiFiskom" class="form-control" placeholder="0.00" onkeypress="return hanyaAngka(event)" value="<?= $RealisasiK ?>" readonly>
        </div>
    </div>
    <div class="form-group row">
        <label class="col-lg-4 col-form-label">Realisasi Keuangan Komulatif (%)</label>
        <div class="col-sm-8">
            <input type="text" name="RealisasiKeuKom" id="RealisasiKeuKom" class="form-control" placeholder="0.00" onkeypress="return hanyaAngka(event)" value="<?= $RealisasiKeuK ?>" readonly>
        </div>
    </div>

    <hr>
    <input type="hidden" name="JobNo" id="JobNo" class="form-control" value="<?= $JobNo ?>">
    <input type="hidden" name="JobNm" id="JobNm" class="form-control" value="<?= $JobNm ?>">
...
<script type="text/javascript">
    $(function() {
        ...
        $('#MyForm').submit(function(e) {
            ...
            $.ajax({
                url: "<?= base_url('Rppm/SimpanProgressFisik') ?>",
                type: "POST",
                dataType: "JSON",
                data: formData,
                cache: false,
